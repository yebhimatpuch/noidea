...
hist(r1, main = "df = 2", xlab = "Value", col = "yellow")
hist(r2, main = "df = 10", xlab = "Value", col = "red")
hist(r3, main = "df = 25", xlab = "Value", col = "cyan")
...
f5 = qf(c(0.25,0.5,0.75,0.999), 10, 20) #(iii)
print(f5)
